pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/cit-intranet'                               //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-cit/cit-intranet.git' //<-----change this to match this new repository!
